...
import es.keensoft.config.audit.AuditEventConverter;
import es.keensoft.domain.PersistentAuditEvent;
...
import static es.keensoft.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
