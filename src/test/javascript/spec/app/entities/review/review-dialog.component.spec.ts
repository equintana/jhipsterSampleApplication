...
import { ReviewDialogComponent } from '../../../../../../main/webapp/app/entities/review/review-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Review Management Dialog Component', () => {
        let comp: ReviewDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ReviewDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'reviewListModification', content: 'OK'});
